    ...
    >
      <nav className="flex items-center justify-between px-8 max-w-7xl mx-auto w-full">
        ...
        <div className="flex items-center space-x-6">
          <Link
            href="/login"
            className="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-200 hover:border-gray-300 hover:bg-gray-50 hover:text-black rounded-md transition-all duration-200 hover:-translate-y-0.5 hover:shadow-sm active:scale-95"
          >
            Login
          </Link>
          <Link
